...
return [
    ...
    'verification' => [
        ...
        'subtitle_women_only' => 'TripSalama est réservé exclusivement aux femmes',
        ...
        'permission_denied' => 'Accès à la caméra refusé. Veuillez autoriser l\'accès.',
        ...
        'manual_review_required' => 'Vérification manuelle requise',
        'skip_for_now' => 'Passer pour l\'instant',
        'continue' => 'Continuer',
        'start_camera' => 'Démarrer la caméra',
        'position_face' => 'Positionnez votre visage dans le cadre',
        'ready_to_capture' => 'Parfait ! Vous pouvez prendre la photo',
        'face_detected' => 'Visage détecté',
        'capture_hint' => 'Appuyez pour capturer',
        'review_photo' => 'Vérifiez votre photo',
        'review_instructions' => 'Assurez-vous que votre visage est bien visible',
        'check_face_visible' => 'Visage visible',
        'check_good_lighting' => 'Bon éclairage',
        'check_clear_photo' => 'Photo nette',
        'verify_identity' => 'Vérifier mon identité',
        'ai_analyzing' => 'Notre IA analyse votre photo...',
        'step_validating' => 'Validation de l\'image...',
        'step_preparing' => 'Préparation de l\'analyse...',
        'step_analyzing' => 'Analyse IA en cours...',
        'step_verifying' => 'Vérification de l\'identité...',
        'step_processing' => 'Traitement des résultats...',
        'step_complete' => 'Analyse terminée',
        'result_verified' => 'Identité vérifiée !',
        'result_pending' => 'Vérification en cours',
        'result_rejected' => 'Vérification refusée',
        'result_error' => 'Erreur de vérification',
        'continue_registration' => 'Continuer l\'inscription',
        'continue_anyway' => 'Continuer quand même',
        'try_again' => 'Réessayer',
        'confidence_level' => 'Niveau de confiance',
        'error_occurred' => 'Une erreur est survenue lors de la vérification',

        // Vérification de genre (Étape 1)
        'gender_step_title' => 'Vérification du genre',
        'gender_step_subtitle' => 'TripSalama est une application réservée aux femmes',
        'gender_step_description' => 'Prenez une photo de votre visage pour vérifier votre identité',
        'gender_verified_female' => 'Vérification réussie ! Vous pouvez continuer.',
        'not_real_person' => 'La photo ne semble pas montrer une personne réelle',
        'face_not_visible' => 'Votre visage n\'est pas suffisamment visible',
        'fraud_detected' => 'Des signes de manipulation ont été détectés',
        'men_not_allowed' => 'TripSalama est réservé exclusivement aux femmes. Nous ne pouvons pas accepter votre inscription.',
        'must_be_adult' => 'Vous devez être majeure pour vous inscrire',
        'low_confidence' => 'La vérification n\'est pas concluante. Veuillez reprendre la photo.',
        'verification_failed' => 'La vérification a échoué. Veuillez réessayer.',
        'ai_unavailable' => 'Le service de vérification est temporairement indisponible',
        'ai_error' => 'Erreur lors de l\'analyse. Veuillez réessayer.',
        'ai_parse_error' => 'Erreur lors du traitement de la réponse',
        'gender_step_required' => 'Vous devez d\'abord passer l\'étape de vérification du genre',
        'continue_for_manual_review' => 'Vous pouvez continuer. Votre profil sera vérifié manuellement.',
        'invalid_image' => 'L\'image fournie n\'est pas valide',

        // Scan carte d'identité (Étape 2)
        'id_step_title' => 'Vérification de la pièce d\'identité',
        'id_step_subtitle' => 'Scannez votre carte d\'identité pour compléter votre inscription',
        'id_step_description' => 'Placez votre carte d\'identité bien à plat et prenez une photo claire',
        'id_tips_title' => 'Conseils pour une bonne capture',
        'id_tip_flat' => 'Placez la carte bien à plat',
        'id_tip_lighting' => 'Assurez un bon éclairage, sans reflets',
        'id_tip_complete' => 'Toute la carte doit être visible',
        'id_tip_focus' => 'La photo doit être nette et lisible',
        'id_verified' => 'Carte d\'identité vérifiée avec succès',
        'id_not_female' => 'La pièce d\'identité n\'appartient pas à une femme',
        'invalid_id_document' => 'Ce document n\'est pas une pièce d\'identité valide',
        'id_not_readable' => 'La carte n\'est pas suffisamment lisible. Veuillez reprendre la photo.',
        'id_fraud_detected' => 'Des signes de falsification ont été détectés',
        'id_missing_info' => 'Certaines informations n\'ont pas pu être lues. Veuillez reprendre la photo.',
        'id_low_confidence' => 'La lecture n\'est pas concluante. Veuillez reprendre la photo.',
        'id_verification_failed' => 'La vérification de la carte a échoué',
        'scan_id_card' => 'Scanner ma carte d\'identité',
        'capture_id' => 'Capturer la carte',
        'analyzing_id' => 'Analyse de la carte en cours...',

        // Formulaire pré-rempli (Étape 3)
        'form_step_title' => 'Complétez votre inscription',
        'form_step_subtitle' => 'Vos informations ont été pré-remplies depuis votre carte d\'identité',
        'form_prefilled_notice' => 'Les champs ci-dessous ont été remplis automatiquement. Vous pouvez les modifier si nécessaire.',
        ...
        'progress_gender' => 'Vérification du visage',
        'progress_id' => 'Scan de la carte',
        'progress_form' => 'Formulaire',
    ],
