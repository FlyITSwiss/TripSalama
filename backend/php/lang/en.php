...
return [
    ...
    'msg' => [
        ...
        'password_reset_sent' => 'If this email address exists, a reset link has been sent.',
        ...
        'country_activated' => 'Country activated successfully',
        'country_deactivated' => 'Country deactivated successfully',
        'default_country_set' => 'Default country set successfully',
        'prayer_times_enabled' => 'Prayer times enabled',
        'prayer_times_disabled' => 'Prayer times disabled',
        'arabic_enabled' => 'Arabic language enabled',
        'arabic_disabled' => 'Arabic language disabled',
    ],
    ...
    'error' => [
        ...
        'cannot_deactivate_default' => 'Cannot deactivate the default country',
    ...
    'verification' => [
        ...
        'subtitle_women_only' => 'TripSalama is exclusively for women',
        ...
        'permission_denied' => 'Camera access denied. Please allow access.',
        'no_camera' => 'No camera detected on this device',
        ...
        'ready_to_capture' => 'Perfect! You can take the photo',
        'face_detected' => 'Face detected',
        'capture_hint' => 'Tap to capture',
        'review_photo' => 'Review your photo',
        'review_instructions' => 'Make sure your face is clearly visible',
        'check_face_visible' => 'Face visible',
        'check_good_lighting' => 'Good lighting',
        'check_clear_photo' => 'Clear photo',
        'verify_identity' => 'Verify my identity',
        'ai_analyzing' => 'Our AI is analyzing your photo...',
        'step_validating' => 'Validating image...',
        'step_preparing' => 'Preparing analysis...',
        'step_analyzing' => 'AI analysis in progress...',
        'step_verifying' => 'Verifying identity...',
        'step_processing' => 'Processing results...',
        'step_complete' => 'Analysis complete',
        'result_verified' => 'Identity verified!',
        'result_pending' => 'Verification in progress',
        'result_rejected' => 'Verification rejected',
        'result_error' => 'Verification error',
        'continue_registration' => 'Continue registration',
        'continue_anyway' => 'Continue anyway',
        'try_again' => 'Try again',
        'confidence_level' => 'Confidence level',
        'error_occurred' => 'An error occurred during verification',

        // Gender verification (Step 1)
        'gender_step_title' => 'Gender Verification',
        'gender_step_subtitle' => 'TripSalama is an app exclusively for women',
        'gender_step_description' => 'Take a photo of your face to verify your identity',
        'gender_verified_female' => 'Verification successful! You can continue.',
        'not_real_person' => 'The photo does not appear to show a real person',
        'face_not_visible' => 'Your face is not sufficiently visible',
        'fraud_detected' => 'Signs of manipulation have been detected',
        'men_not_allowed' => 'TripSalama is exclusively for women. We cannot accept your registration.',
        'must_be_adult' => 'You must be an adult to register',
        'low_confidence' => 'Verification is inconclusive. Please retake the photo.',
        'verification_failed' => 'Verification failed. Please try again.',
        'ai_unavailable' => 'Verification service is temporarily unavailable',
        'ai_error' => 'Error during analysis. Please try again.',
        'ai_parse_error' => 'Error processing response',
        'gender_step_required' => 'You must first complete the gender verification step',
        'continue_for_manual_review' => 'You can continue. Your profile will be manually verified.',
        'invalid_image' => 'The provided image is not valid',

        // ID card scan (Step 2)
        'id_step_title' => 'ID Card Verification',
        'id_step_subtitle' => 'Scan your ID card to complete your registration',
        'id_step_description' => 'Place your ID card flat and take a clear photo',
        'id_tips_title' => 'Tips for a good capture',
        'id_tip_flat' => 'Place the card flat',
        'id_tip_lighting' => 'Ensure good lighting, no reflections',
        'id_tip_complete' => 'The entire card must be visible',
        'id_tip_focus' => 'The photo must be sharp and readable',
        'id_verified' => 'ID card verified successfully',
        'id_not_female' => 'The ID card does not belong to a woman',
        'invalid_id_document' => 'This document is not a valid ID',
        'id_not_readable' => 'The card is not readable enough. Please retake the photo.',
        'id_fraud_detected' => 'Signs of forgery have been detected',
        'id_missing_info' => 'Some information could not be read. Please retake the photo.',
        'id_low_confidence' => 'Reading is inconclusive. Please retake the photo.',
        'id_verification_failed' => 'ID card verification failed',
        'scan_id_card' => 'Scan my ID card',
        'capture_id' => 'Capture card',
        'analyzing_id' => 'Analyzing card...',

        // Pre-filled form (Step 3)
        'form_step_title' => 'Complete your registration',
        'form_step_subtitle' => 'Your information has been pre-filled from your ID card',
        'form_prefilled_notice' => 'The fields below have been filled automatically. You can modify them if needed.',
        ...
        'progress_gender' => 'Face verification',
        'progress_id' => 'ID card scan',
        'progress_form' => 'Form',
    ],
    ...
    'admin' => [
        ...
        'dashboard' => 'Dashboard',
        'dashboard_desc' => 'TripSalama system overview',
        'users' => 'Users',
        'drivers' => 'Drivers',
        'passengers' => 'Passengers',
        'rides' => 'Rides',
        'rides_today' => 'Rides today',
        'active_alerts' => 'Active SOS alerts',
        'quick_actions' => 'Quick actions',
        'recent_activity' => 'Recent activity',
        'active_sos_alerts' => 'active SOS alerts',
        'requires_attention' => 'Requires attention',
        'rides_created_today' => 'rides created today',
        'today' => 'Today',
        'no_recent_activity' => 'No recent activity',
        'payments' => 'Payments',
        'promo_codes' => 'Promo codes',
        'settings' => 'Settings',
        'settings_desc' => 'Configure security features and application options',
        'reports' => 'Reports',
        ...
        // Stats cards
        'sms_today' => 'SMS sent today',
        'sos_recordings_today' => 'SOS recordings today',
        'pins_sent_today' => 'PIN codes sent today',
        'storage_used' => 'Storage used',
        // Safety settings
        'safety_settings' => 'Safety settings',
        'safety_settings_desc' => 'PIN verification and ride protection',
        'pin_verification' => 'PIN verification',
        'pin_verification_desc' => 'Send PIN code via SMS to start a ride',
        'max_pin_attempts' => 'Maximum attempts',
        'max_pin_attempts_desc' => 'Number of attempts before PIN is blocked',
        'pin_expiry' => 'PIN expiry (minutes)',
        'pin_expiry_desc' => 'Validity duration of PIN code in minutes',
        // Checklist settings
        'checklist_settings' => 'Driver checklist',
        'checklist_settings_desc' => 'Required daily verifications',
        'checklist_required' => 'Checklist required',
        'checklist_required_desc' => 'Require checklist before going online',
        'dashcam_required' => 'Dashcam required',
        'dashcam_required_desc' => 'Require photo proof of installed dashcam',
        // SMS settings
        'sms_settings' => 'SMS configuration',
        'sms_settings_desc' => 'SMS notifications via Twilio',
        'sms_enabled' => 'SMS enabled',
        'sms_enabled_desc' => 'Enable SMS sending for notifications',
        // SOS settings
        'sos_settings' => 'SOS emergency system',
        'sos_settings_desc' => 'Emergency alerts and recordings',
        'sos_auto_call' => 'Automatic emergency call',
        'sos_auto_call_desc' => 'Automatically call emergency contacts',
        'recording_max_duration' => 'Max recording duration (sec)',
        'recording_max_duration_desc' => 'Maximum duration for SOS recordings',
        // Country management
        'countries' => 'Country management',
        'countries_desc' => 'Configure available countries and their settings',
        ...
        'country_inactive' => 'Country inactive',
        'set_default' => 'Set as default',
        ...
        'prayer_times_desc' => 'Display prayer times in the application',
        'arabic_language' => 'Arabic language',
        'arabic_language_desc' => 'Enable Arabic language for this country',
    ...
    'pin' => [
        ...
        'verify' => 'Verify',
        'resend' => 'Resend code',
        'sent_to_passenger' => 'Code sent via SMS to passenger',
        'ask_passenger' => 'Ask your passenger for the code',
        'invalid' => 'Invalid code',
        'expired' => 'Code expired',
        'max_attempts' => 'Maximum attempts reached',
        'attempts_left' => ':count attempts remaining',
        ...
        'security_notice' => 'Never share this code by phone',
        'driver_instruction' => 'The passenger will give you this code to start the ride',
        'passenger_instruction' => 'Give this code to your driver to start the ride',
    ],

    // Driver safety checklist
    'checklist' => [
        'title' => 'Safety checklist',
        'subtitle' => 'Verify these items before starting',
        'daily_check' => 'Daily verification',
        'valid_until' => 'Valid until midnight',
        'already_completed' => 'Checklist already completed today',
        'complete_to_go_online' => 'Complete the checklist to go online',
        'seatbelt' => 'Seatbelt functional',
        'mirrors' => 'Mirrors properly adjusted',
        'dashcam' => 'Dashcam installed and functional',
        'dashcam_photo' => 'Dashcam photo',
        'take_dashcam_photo' => 'Take a photo of your dashcam',
        'upload_photo' => 'Upload a photo',
        'photo_required' => 'A photo of your dashcam is required',
        'photo_uploaded' => 'Photo uploaded successfully',
        'lights' => 'Headlights and tail lights functional',
        'tires' => 'Tires in good condition',
        'documents' => 'Documents up to date (license, insurance)',
        'fuel' => 'Sufficient fuel level',
        'cleanliness' => 'Vehicle clean',
        'confirm_all' => 'I confirm I have verified all these items',
        'submit' => 'Submit checklist',
        'completed' => 'Checklist completed',
        'completion_required' => 'Checklist must be completed to go online',
        'photo_verification' => 'Verifying photo...',
        'photo_approved' => 'Photo approved',
        'photo_rejected' => 'Photo not compliant, please try again',
        'all_required' => 'All checklist items are required',
    ...
    'recording' => [
        ...
        'permission_required' => 'Allow access to record',
        'not_supported' => 'Recording not supported on this device',
        'video' => 'Video',
        'audio' => 'Audio only',
        'switch_mode' => 'Switch mode',
        'evidence_saved' => 'Evidence recorded',
        'auto_upload' => 'Automatic upload enabled',
        'storage_info' => 'Recordings are kept for 30 days',
