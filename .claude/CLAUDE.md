...
| **Tests E2E visuels** | `npm run test:visual` | Tous les tests Puppeteer |

**INTERDIT de donner des commandes manuelles comme :**
- ❌ `cd android && ./gradlew assembleRelease`
- ❌ `npx cap sync android`
- ❌ `node tests/puppeteer/test-xxx.js`
...
| 5 | **Test Puppeteer PROD** | `node tests/puppeteer/smoke-tests.js --env=production` |
